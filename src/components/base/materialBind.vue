  ...
  <div class="admin">
        ...
        <div class="query-content transDrop">
          <el-form size="mini" :inline="true" label-width="80px" :model="query" class="demo-form-inline"
            ...
            <el-col :xs="24" :sm="8" :lg="6" :xl="6">
                <el-form-item prop="factoryLogisticsCode" :label="$t('materialBindSearch.factoryLogisticsCode') + '：'">
                  <el-select
                                   v-model="query.factoryLogisticsCode"
                                   reserve-keyword @change="getShipper()"
                                   placeholder="请选择">
                          <el-option v-for="item in searchFactoryDcList"
                                     :key="item.factoryLogisticsCode"
                                     :label="item.name"
                                     :value="item.factoryLogisticsCode" :title="item.name"></el-option>
                        </el-select>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="8" :lg="6" :xl="6">
                <el-form-item prop="shipperCode" :label="$t('materialBindSearch.shipperCode') + '：'">
                  <el-select
                          ...
                          <el-option v-for="item in searchShipperList"
                                     ...
                                     :value="item.shipperCode" :title="item.shipperName"></el-option>
                        </el-select>
                  <!-- <el-input v-model="query.shipperCode"
                            :placeholder="$t('common.pleaseEnter')"
                            :maxlength='20'></el-input> -->
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="8" :lg="6" :xl="6">
                <el-form-item prop="materialCode" :label="$t('materialBindSearch.materialCode') + '：'">
              ...
              <el-col :xs="24" :sm="8" :lg="6" :xl="6">
                <el-form-item prop="materialName" :label="$t('materialBindSearch.materialName') + '：'">
              ...
              <el-col :xs="24" :sm="8" :lg="6" :xl="6">
                <el-form-item prop="materialType" :label="$t('materialBindSearch.materialType') + '：'">
                  <el-select v-model="query.materialType" :placeholder="$t('common.pleaseChoose')">
              ...
              <el-col :xs="24" :sm="8" :lg="6" :xl="6">
                <el-form-item prop="sixNineCode" :label="$t('materialBindSearch.sixNineCode') + '：'">
                  <el-input v-model="query.sixNineCode"
                            :placeholder="$t('common.pleaseEnter')"
                            :maxlength='30'></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="8" :lg="6" :xl="6">
                <el-form-item prop="bindSourceSystem" :label="$t('materialBindSearch.bindSourceSystem') + '：'">
                  <el-select v-model="query.bindSourceSystem"
                             :placeholder="$t('common.pleaseChoose')">
                    <el-option v-for="item in this.dict.bindSourceSystem" :key="item.code"
    ...
    <div class="list_mater list_operation">
      <el-table highlight-current-row stripe :data="currentList" v-loading="visible.listLoading" @selection-change="handleSelection"
        ...
        <el-table-column align="center" :label="$t('materialThead.materialCode')" prop="materialCode"
        ...
        <el-table-column align="center" :label="$t('materialThead.transportFlag')" prop="transportFlag"
                         :formatter="formatterTransportFlag" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" :label="$t('materialThead.barCode')" prop="barCode"
                         show-overflow-tooltip></el-table-column>

        <el-table-column align="center" :label="$t('materialThead.expirationDate')" prop="expirationDate"
                         show-overflow-tooltip></el-table-column>
        <el-table-column align="center" :label="$t('materialThead.specification')" prop="specification"
                         show-overflow-tooltip></el-table-column>
        ...
        <el-table-column align="center" :label="$t('materialThead.baseUnit')" prop="baseUnitName"
                         show-overflow-tooltip></el-table-column>
        <el-table-column align="center" :label="$t('materialThead.minUnit')" prop="minUnitName"
                         show-overflow-tooltip></el-table-column>
        <el-table-column align="center" :label="$t('materialThead.sourceSystem')" prop="sourceSystem"
                         show-overflow-tooltip></el-table-column>
        <el-table-column align="center" width="120" :label="$t('materialThead.creater')" prop="createrName"
                         show-overflow-tooltip></el-table-column>
        <el-table-column align="center" width="170" :label="$t('materialThead.createTime')" prop="createTime"
        ...
        <!-- <el-table-column align="center" width="60" :label="$t('commonThead.operation')" fixed="right">
          <template slot-scope="scope">
            <el-tooltip content="绑定" placement="top" effect="light" >
              <div @click="handleMod(scope.row)" class="operation_icon icon1"></div>
            </el-tooltip>
          </template>
        </el-table-column> -->
        <el-table-column align="center" :label="$t('commonThead.operation')"
                                 show-overflow-tooltip>
          <template slot-scope="scope">
              <div class="hand" @click="handleMod(scope.row)">绑定</div>
          </template>
      </el-table-column>
      </el-table>
      <!-- 工具条 -->
                  ...
                  <div class="grid-content bg-purple">
                    <el-form-item label="物料照片:" prop="materialImage">
                      <el-upload class="upload-demo" :disabled="visible.isView"
                        ...
                        &lt;!&ndash;<el-button size="small" type="primary" :disabled="visible.selDisableT">&ndash;&gt;
                        &lt;!&ndash;点击上传
                        </el-button>&ndash;&gt;
                       &lt;!&ndash; <i class="el-icon-plus" :disabled="visible.selDisableT"></i>
                        <div slot="tip" class="el-upload__tip">只能上传jpg/jpeg/png图片，且不超过5MB</div>&ndash;&gt;
                      </el-upload>
                    </el-form-item>
                  </div>
                </el-col>-->
                ...
                <el-col :span="12">
                  <div class="grid-content">
                    <el-form-item label="物料照片：" prop="materialImage">
                      ...
                      <img @click="handlePreview(materialImage[0])"
                           :src="download_path + editForm.materialImage" style="max-width: 190px;"/>
                    </el-form-item>
                  </div>
                </el-col>
              </el-row>
                ...
                <el-col :span="12">
                  <div class="grid-content">
                    <el-form-item label="货主物料别称：" prop="shipperMaterialName">
                      <el-input :maxlength="50" :disabled="visible.isExtView"
                  ...
                  <div class="grid-content">
                    <el-form-item label="出库方式：" prop="outboundWay">
                      <el-select :disabled="visible.isExtView"
                                 v-model="materialExtForm.outboundWay" placeholder="请选择" clearable>
                ...
                <el-col :span="12">
                  <div class="grid-content">
                    <el-form-item label="净重：" prop="netWeight">
                      <el-input :maxlength="20" :readonly="visible.isExtView"
                ...
                <el-col :span="12">
                  <div class="grid-content">
                    <el-form-item label="熟化期：" prop="maturePeriod">
                      <el-input :maxlength="20" :readonly="visible.isExtView"
                                v-model="materialExtForm.maturePeriod">
                ...
                <el-col :span="12">
                  <div class="grid-content">
                    <el-form-item label="重抛货：" prop="heavyThrowGoods">
                      <el-select :disabled="visible.isExtView"
                                 v-model="materialExtForm.heavyThrowGoods" placeholder="请选择">
                ...
                <el-col :span="12">
                  <div class="grid-content">
                    <el-form-item label="超期合格天数：" prop="numOfQualifiedProducts">
                      <el-input :maxlength="5" :disabled="visible.isExtView"
                                v-model="materialExtForm.numOfQualifiedProducts">
                        <template slot="suffix">天</template>
                      </el-input>
                    </el-form-item>
                  </div>
  ...
  export default {
    data() {
      return {
        ...
        download_path: config.azure_download_path,
        upLoadData: {
        ...
        shipperFormRules: {
          shipperMaterialName: [
            {required: false, message: '只可输入中文、英文、数字及. - @ ()', trigger: 'blur', validator: this.textVerify}
          ],
          shipperMaterialCode: [
            {required: false, message: '只可输入中文、英文、数字及. - @ ()', trigger: 'blur', validator: this.textVerify}
          ],
          ...
          price: [
            {required: false, message: '只可输入中文、英文、数字及. -)', trigger: 'blur', validator: this.validatePrice}
          ],
          ...
          length: [
            {required: false, trigger: 'blur', validator: this.mandatoryVerifylwh}
          ],
          width: [
            {required: false, trigger: 'blur', validator: this.mandatoryVerifylwh}
          ],
          ...
          palletizingRule: [
            {required: true, message: '请输入码盘规则'},
            {required: true, message: '请输入数字', trigger: 'blur', validator: this.mandatoryVerifyFigure}
          ],
          numOfQualifiedProducts: [
            {required: true, message: '请输入超期合格品天数'},
            {required: true, message: '请输入数字', trigger: 'blur', validator: this.mandatoryVerifyFigure}
          ],
          denominator: [
            {required: true, message: '请输入超期合格品分母'},
            {required: true, message: '请输入数字', trigger: 'blur', validator: this.mandatoryVerifyFigure}
          ],
          batchAttr: [
    ...
    methods: {
      ...
      mandatoryVerifylwh(rule, value, callback) {
        let reg = /^[0-9]\d*(\.\d+)?$/;
      ...
      textVerify(rule, value, callback) {
        util.validMDName(rule, value, callback);
      },
      validatePrice(rule, value, callback) {
        util.validPrice(rule, value, callback);
      },
      // 分页
      pageChange(page) {
      ...
      // 获取物料列表
      selectList() {
        if (util.isEmpty(this.init) && (util.isEmpty(this.query.factoryLogisticsCode) || util.isEmpty(this.query.shipperCode))) {
        ...
        _this.currentList = [];
        util.publicpost('/material/bind/list/pager', {
          factoryLogisticsCode: _this.query.factoryLogisticsCode,
          materialName: _this.query.materialName,
          materialCode: _this.query.materialCode,
          materialType: _this.query.materialType,
          barCode: _this.query.sixNineCode,
          bindSourceSystem: _this.query.bindSourceSystem,
          ...
          util.publicpost('/material/queryByCode', {
            ...
            if (res.code === 0) {
              ...
              _this.editForm = {
                ...
                materialImage: _this.currentRow.materialImage
              };
      ...
      formatUnitDict: function (json, key) {
     ...
     /** formatEnumVal: function (json, key) {
            for (let i = 0; i < json.length; i++) {
                let code = json[i].code;
                if (key === code) {
                    return json[i].des;
      ...
      handleMod(row) {
        ...
        if (row.materialCode) {
          util.publicpost('/material/queryByCode', {
            ...
            if (res.code === 0) {
              ...
              // 加载物料扩展信息列表
              //_this.selectExtList();
              _this.queryMaterialApiDTOListByMdCode(row);
            } else {
              _this.errorMsg(res.msg);
            }
          });
        ...
        _this.visible.editForm = true;
        _this.visible.editExtDetailForm = true;
        _this.visible.selDisableT = true;
      },
        queryMaterialApiDTOListByMdCode(row){
               let _this = this;
               util.publicpost('/material/ext/queryMaterialApiDTOListByMdCode', {
                             materialCode: row.materialCode
                             }, function (res) {
                               if (res.code === 0) {
                                  if(res.data!=null){
                                     _this.materialExtForm.shipperMaterialCode = res.data.shipperMaterialCode;
                                          _this.materialExtForm.shipperMaterialName = res.data.shipperMaterialAlias;
                                          _this.materialExtForm.cartonCode = res.data.cartonCode;
                                          _this.materialExtForm.goodsCodeOne = res.data.goodsCodeOne;
                                          _this.materialExtForm.goodsCodeTwo = res.data.goodsCodeTwo;
                                          _this.materialExtForm.batchAttr = res.data.batchAttrEnum;
                                          _this.materialExtForm.outboundWay =res.data.outboundWay;
                                          _this.materialExtForm.price = res.data.price;
                                          _this.materialExtForm.materialGroupCode = res.data.materialGroupCode;
                                          _this.materialExtForm.length = res.data.length;
                                          var lengthUnit = res.data.lengthUnit;
                                          var lengthUnitJson = _this.unitDict.lengthUnit;
                                          _this.materialExtForm.lengthUnit = _this.formatUnitDict(lengthUnitJson, lengthUnit);
                                          // _this.materialExtForm.lengthUnit = res.data.lengthUnit;
                                          _this.materialExtForm.width = res.data.width;
                                          var widthUnit = res.data.widthUnit;
                                          var widthUnitJson = _this.unitDict.lengthUnit;
                                          _this.materialExtForm.widthUnit = _this.formatUnitDict(widthUnitJson, widthUnit);
                                          // _this.materialExtForm.widthUnit = res.data.widthUnit;
                                          _this.materialExtForm.height = res.data.height;
                                          var heightUnit = res.data.heightUnit;
                                          var heightUnitJson = _this.unitDict.lengthUnit;
                                          _this.materialExtForm.heightUnit = _this.formatUnitDict(heightUnitJson, heightUnit);
                                          // _this.materialExtForm.heightUnit = res.data.heightUnit;
                                          _this.materialExtForm.volume = res.data.volume;
                                          var volumeUnit = res.data.volumeUnit;
                                          var volumeUnitJson = _this.unitDict.volumeUnit;
                                          _this.materialExtForm.volumeUnit = _this.formatUnitDict(volumeUnitJson, volumeUnit);
                                          // _this.materialExtForm.volumeUnit = res.data.volumeUnit;
                                          _this.materialExtForm.grossWeight = res.data.grossWeight;
                                          var grossWeightUnit = res.data.grossWeightUnit;
                                          var grossWeightUnitJson = _this.unitDict.weightUnit;
                                          _this.materialExtForm.grossWeightUnit = _this.formatUnitDict(grossWeightUnitJson, grossWeightUnit);
                                          // _this.materialExtForm.grossWeightUnit = res.data.grossWeightUnit;
                                          _this.materialExtForm.netWeight = res.data.netWeight;
                                          var netWeightUnit = res.data.netWeightUnit;
                                          var netWeightUnitJson = _this.unitDict.weightUnit;
                                          _this.materialExtForm.netWeightUnit = _this.formatUnitDict(netWeightUnitJson, netWeightUnit);
                                          // _this.materialExtForm.netWeightUnit = res.data.netWeightUnit;
                                          _this.materialExtForm.palletizingRule = res.data.palletizingRule;
                                          _this.materialExtForm.numOfQualifiedProducts = res.data.numOfQualifiedProducts;
                                          _this.materialExtForm.denominator = res.data.denominator;
                                          _this.materialExtForm.maturePeriod = res.data.maturePeriod;
                                          // _this.materialExtForm.heavyThres.dataGoods = res.data.heavyThres.dataGoods;
                                         /** if(res.data.heavyThres.dataGoods === 1){
                                              _this.materialExtForm.heavyThres.dataGoods = 'YES';
                                          }else if(res.data.heavyThres.dataGoods === 2){
                                              _this.materialExtForm.heavyThres.dataGoods = 'NO';
                                          }else{
                                          }**/
                                          _this.materialExtForm.freshFlag = res.data.freshFlagEnum;
                                          _this.materialExtForm.coefficient = res.data.coefficient;
                                          _this.materialExtForm.warningThreshold = res.data.warningThreshold;
                                           _this.materialExtForm.heavyThrowGoods=res.data.heavyThrowGoodsEnum
                                  }
                               } else {
                                 _this.errorMsg(res.msg);
                               }
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            util.publicpost('/material/add', {
              ...
              if (res.success) {
                if (res.code === 4) {
                  _this.successMsg('物料信息已存在，请继续编辑扩展信息');
       ...
       */
      handleDbl(row) {
        console.log(this.visible.addExtButton);
        let _this = this;
        if (row.isEditing) {
      ...
      saveExtHead(row) {
        ...
        util.publicpost('/material/ext/insert', _this.materialExtForm, function (res) {
          if (res.success) {
            ...
            _this.$alert('<p style="color:#f56c6c;text-align: center">扩展属性保存未成功，请重试！</p>', '提示', {dangerouslyUseHTMLString: true});
          }
        });
      },
      /**
      ...
      saveExtDetail(formName) {
        ...
        console.log(_this.materialExtForm.heavyThrowGoods);
        _this.$refs[formName].validate((valid) => {
          if (valid) {
            util.publicpost('/material/ext/insert', {
              materialCode: _this.currentRow.materialCode,
              shipperCode: _this.query.shipperCode,
              storageCenterCode: _this.query.factoryLogisticsCode,
      ...
      getFactoryLogistics() {
        let _this = this;
          util.publicpost('/material/bind/getFactoryLogistics', {
          }, function (res) {
            if (res.success) {
              _this.searchFactoryDcList = res.data;
            } else {
      ...
      download() {
        ...
        var templateUrl = '';
        if (this.operType == 0) {
          templateUrl = config.file_path_ip + '/album/mould/LOMS%E7%89%A9%E6%96%99%E5%AF%BC%E5%85%A5%E6%A8%A1%E6%9D%BF.xlsx';
        } else if (this.operType == 1) {
          templateUrl = config.file_path_ip + '/album/mould/LOMS%E7%89%A9%E6%96%99%E6%89%B9%E9%87%8F%E4%BF%AE%E6%94%B9%E6%A8%A1%E6%9D%BF.xlsx';
        }
        fileObj = window.open(
          templateUrl,
          '_blank'
      ...
      formatterTransportFlag(row, column) {
        var status = row.transportFlag;
        var json = this.dict.transportFlag;
        return util.formatDict(json, status);
      },
      ...
      changeTransportFlag() {
        if (this.editForm.transportFlag === 'NO' || this.editForm.transportFlag === '') {
          this.FormRules = {
            ...
            barCode: [
              {required: true, message: '请输入69编码', trigger: this.trigger},
              {required: true, message: '只能输入数字', trigger: this.trigger, validator: this.mandatoryVerifyFigure}
            ],
            expirationDate: [
              {required: true, message: '请输入保质期', trigger: this.trigger},
              {required: true, message: '只能输入数字', trigger: 'blur', validator: this.mandatoryVerifyFigure}
          ...
          this.FormRules = {
            ...
            specification: [
              {required: false, message: '请输入包装规格', trigger: this.trigger}
            ],
            baseUnit: [
